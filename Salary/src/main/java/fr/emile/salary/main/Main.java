...
//		test();
	...
	public static void run() {
		...
		myStaff.add(new SalesMan("Léon", "Vendtout", 25, "2001", 25000.0));
		myStaff.add(new Technician("Yves", "Bosseur", 28, "1998", 1200));
		myStaff.add(new Technician("Reyves", "grouseur", 28, "1998", 1020));
		myStaff.add(new WarehouseWorker("Jeanne", "Stocktout", 32, "1998", 50));
		myStaff.add(new RiskyWarehouseWorker("Krisarim", "AzetAbe", 33, "2003", 32));

		myStaff.add(new RiskyTechnician("Jean", "Flippe", 28, "2000", 1100));
		myStaff.add(new RiskyWarehouseWorker("Karim", "Abordage", 30, "2001", 45));
		myStaff.add(new Seller("Roger", "poutoBusiness", 45, "1995", 24000.0));
		...
		System.out.printf("Total worker number : %d \n", myStaff.getMaxWorkerNumber());
	}
